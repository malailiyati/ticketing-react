  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full bg-white shadow z-[999]">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between px-5 md:px-10 py-4">
          {/* Logo kiri */}
          <svg
            width="130"
            height="52"
          ...
          >
            ...
            />
            <path
              d="M124.098 27.6533L123.23 27.4878L123.108 26.6371C123.106 26.6246 123.101 26.6129 123.092 26.6038C123.084 26.5946 123.072 26.5884 123.06 26.5861C123.048 26.5837 123.035 26.5852 123.024 26.5905C123.013 26.5957 123.004 26.6045 122.997 26.6154L122.576 27.3628L121.73 27.2015C121.718 27.1992 121.705 27.2008 121.694 27.2061C121.683 27.2114 121.673 27.2201 121.667 27.2311C121.661 27.242 121.658 27.2546 121.659 27.2672C121.66 27.2798 121.665 27.2918 121.673 27.3014L122.233 27.9724L121.812 28.7196C121.806 28.7308 121.803 28.7434 121.804 28.756C121.805 28.7689 121.811 28.781 121.819 28.7906C121.827 28.8002 121.838 28.8067 121.85 28.8098C121.862 28.8128 121.874 28.812 121.886 28.8073L122.665 28.4903L123.239 29.1783C123.247 29.1876 123.258 29.1945 123.27 29.1975C123.282 29.2005 123.294 29.1997 123.306 29.1953C123.317 29.1909 123.327 29.1829 123.334 29.1725C123.341 29.1621 123.345 29.1498 123.344 29.1372L123.329 28.2148L124.116 27.7667C124.127 27.7605 124.136 27.7511 124.141 27.7398C124.146 27.7284 124.148 27.7157 124.147 27.7032C124.144 27.6908 124.138 27.6794 124.13 27.6705C124.121 27.6615 124.11 27.6555 124.098 27.6533Z"
              fill="#1D4ED8"
            />
          </svg>
          ...
          {/* Hamburger tombol, hanya di mobile */}
          <button
          ...
          >
            <div className="space-y-1">
              ...
              <span className="block w-3 h-0.5 bg-gray-700"></span>
              <span className="block w-6 h-0.5 bg-gray-700"></span>
            </div>
          </button>

          {/* Profile / Auth Right desktop, hanya di md ke atas */}
          {!isLoggedIn ? (
            ...
            <div className="hidden md:flex flex-shrink-0 items-center gap-4 relative">
              ...
              >
                <option value="pwt">Location</option>
        ...
        {/* Mobile menu: nav + auth, hanya muncul di bawah md */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 px-6 py-4 flex flex-col items-center gap-4">
            ...
            {!isLoggedIn ? (
              <>
                <NavLink
                  to="/login"
                  className="w-full text-center px-4 py-2 border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white transition"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Sign In
                </NavLink>
